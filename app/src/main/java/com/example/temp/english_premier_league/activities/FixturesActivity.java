...
public class FixturesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarSetup(teamName);

        new FetchData().execute();

        final Intent intent = new Intent(FixturesActivity.this, SingleFixtureActivity.class);
    ...
    private void init() {
        mTeamsRecycleView = findViewById(R.id.fixtures_recycler_view);
