...
public class SinglePlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayerName = findViewById(R.id.single_player_name_BIG);
        mPlayerNumber = findViewById(R.id.single_player_number_BIG);
        mPlayerPosition = findViewById(R.id.single_player_position);
        mPlayerDOB = findViewById(R.id.single_player_DOB_textView);
        mPlayerContactEnd = findViewById(R.id.single_player_ContractUntil_textView);
        mPlayerNationality = findViewById(R.id.single_player_nationality_textView);
        mplayerMarketValue = findViewById(R.id.single_player_market_value);
        mPlayerPositionCode = findViewById(R.id.single_player_postition_Code);
        mPlayerTeamCrest = findViewById(R.id.single_player_big_crest);
