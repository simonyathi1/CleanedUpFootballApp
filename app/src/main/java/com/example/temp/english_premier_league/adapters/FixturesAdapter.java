...
public class FixturesAdapter extends RecyclerView.Adapter<FixturesAdapter.FixtureHolder> {
    ...
    class FixtureHolder extends RecyclerView.ViewHolder {
        ...
        FixtureHolder(View itemView) {
            ...
            homeTeamCrestImageView = itemView.findViewById(R.id.home_team_crest);
            awayTeamCrestImageView = itemView.findViewById(R.id.away_team_crest);
            homeTeamNameTextView = itemView.findViewById(R.id.home_team_name);
            awayTeamNameTextView = itemView.findViewById(R.id.away_team_name);
            homeScoreTextView = itemView.findViewById(R.id.home_team_score);
            awayScoreTextView = itemView.findViewById(R.id.away_team_score);
            competitionNameTextView = itemView.findViewById(R.id.competition_id);
            matchDateTextView = itemView.findViewById(R.id.match_date_small);
            matchTimeTextView = itemView.findViewById(R.id.match_date_time_small);
        }

        //new binder method to bind data to the view
        void bind(final Fixture item, final FixturesAdapter.OnItemClickedListener listener) {
            ArrayList dateTime;
            ...
            matchDateTextView.setText(String.valueOf(dateTime.get(0)));
            matchTimeTextView.setText(String.valueOf(dateTime.get(1)));
